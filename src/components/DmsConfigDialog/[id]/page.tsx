...
const DetailsTableDms: React.FC = () => {
  ...
  const handleSaveChanges = async () => {
    ...
    if (validateInputs(cleanedObject)) {
      ...
      if (response.status === 200 || response.success === true) {
        enqueueSnackbar(t("dms-configuration-updated-successfully"), {
          variant: "success",
        });
        setOpen(false);
      }
  ...
  const handleDelete = async () => {
    ...
    if (response.success === true) {
      enqueueSnackbar("DMS configuration deleted successfully!", {
        variant: "success",
      });
      setOpenModal(false);
  ...
  return (
    ...
    >
          ...
          <>
                  ...
                  <TableBody>
                    {tenantDetails && (
                      <>
                        ...
                        <TableRow>
                          <TableCell style={{ fontWeight: "bold" }}>
                            {t("Accounting-Software.endpoint-url")}
                          </TableCell>
                          <TableCell>{tenantDetails?.endpoint_url}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell style={{ fontWeight: "bold" }}>
                            {t("Accounting-Software.username")}
                          </TableCell>
                          <TableCell>{tenantDetails?.username}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell style={{ fontWeight: "bold" }}>
                            {t("Accounting-Software.repository")}
                          </TableCell>
            ...
            <Grid item xs={12} display="flex" justifyContent="space-evenly">
              <IconButton
                ...
                title={t("Accounting-Software.bearbeiten")}
              >
                <EditIcon />
              </IconButton>
              ...
              <IconButton
                ...
                title={t("Accounting-Software.loschen")}
              >
                <DeleteIcon />
              </IconButton>
            </Grid>
      ...
      <Dialog
        ...
        fullWidth
      >
        <DialogTitle id="alert-dialog-title">{"DMS"}</DialogTitle>
        <DialogContent>
          <Typography
            variant="body1"
            component="span"
