                      ...
                      <TableHead>
                        <TableRow>
                          <TableCell style={{ fontWeight: "bold" }}>
                            {t("Accounting-Software.feld")}
                          </TableCell>
                          <TableCell style={{ fontWeight: "bold" }}>
                            {t("Accounting-Software.wert")}
                          </TableCell>
                        </TableRow>
                      </TableHead>
                      <TableBody>
                        {tenantDetails && (
                          <>
                            ...
                            <TableRow>
                              <TableCell>
                                {t("Accounting-Software.url")}
                              </TableCell>
                              <TableCell>{tenantDetails?.url}</TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                                {t("Accounting-Software.organization_id")}
                              </TableCell>
                              <TableCell>
                                {tenantDetails?.organization_id}
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                                {t("Accounting-Software.event-type")}
                              </TableCell>
                              <TableCell>
                                {
                                  // @ts-ignore
                                  (tenantDetails?.event_type?.document ||
                                    tenantDetails?.event_type) ??
                                    "N/A"
                                }
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                                {t("Accounting-Software.description")}
                              </TableCell>
                              <TableCell>
                            ...
                            <TableRow>
                              <TableCell>
                                {t("Accounting-Software.region")}
                              </TableCell>
                              <TableCell>
                                {tenantDetails?.additional_settings?.region ??
                                  "N/A"}
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                                {t("Accounting-Software.active")}
                              </TableCell>
                              <TableCell>
                                {" "}
                                {tenantDetails?.is_active
                                  ? t("Accounting-Software.yes")
                                  : t("Accounting-Software.no")}
                              </TableCell>
                            </TableRow>
                          </>
                        )}
